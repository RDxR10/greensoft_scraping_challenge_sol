...
This repo contains two scripts that present different approaches to solving Greensoft's scraping challenge. I took around 3 hours for developing `sol_23_07_2025.py` and submitted it early. If there are no connectivity issues, the script typically runs quickly.

The solution was accepted, nevertheless, even though minor issues existed. 

After submission, they included a JS challenge (not sure when). 
